...
export const ApiKeys = () => {
  ...
  const fetchApiKeys = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_ENDPOINT}/api/auth/api-keys`, {
        headers: {
  ...
  const handleRevokeApiKey = async (keyId) => {
    ...
    try {
      const response = await fetch(`${API_ENDPOINT}/api/auth/api-keys/${keyId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${apiToken.token}`
        }
  ...
  const handleRefreshApiKey = async (keyId) => {
    ...
    try {
      const response = await fetch(`${API_ENDPOINT}/api/auth/api-keys/${keyId}/refresh`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${apiToken.token}`
        }
